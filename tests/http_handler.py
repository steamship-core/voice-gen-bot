...
from steamship.invocable.lambda_handler import encode_exception, safely_find_invocable_class
from steamship.utils.signed_urls import upload_to_signed_url
from steamship.utils.url import Verb


def use_local(  # noqa: C901
    client: Steamship,
    package_class,
    context: Optional[InvocationContext] = None,
    config: Optional[dict] = None,
):
    """Set up a local instance of the package."""
    ...
    obj = package_class(client=client, context=context, config=config)
...
def handler(bound_internal_handler, event: Dict, _: Dict = None) -> dict:  # noqa: C901
    ...
    use_fluent_logging = (
        logging_config and logging_port and logging_host != "none" and logging_port != "none"
    )
